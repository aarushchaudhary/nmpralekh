...
export default function ExportPage() {
    ...
    return (
        <div>
            <PageHeader
                title="Consolidated Data Export"
                subtitle="Export aggregated MIS records from all campuses and accumulators"
            />
                ...
                <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
                    ...
                    <div className="px-6 py-4 bg-gradient-to-r from-primary-50 to-primary-100/50 border-b border-gray-100">
                        ...
                        <p className="text-xs text-primary-600/80 mt-0.5">
                            All 7 MIS modules will be included in the export across all campuses
                        </p>
                    </div>
                    ...
                    <div className="p-6 space-y-6">
                        ...
                        <p className="text-xs text-gray-400">
                            Leave dates empty to export all available records from accumulators.
                        </p>
