...
urlpatterns = [
    ...
    path('campuses/<int:pk>/reactivate/',views.CampusReactivateView.as_view(),  name='campus_reactivate'),
    ...
    path('<int:pk>/reactivate/',         views.SchoolReactivateView.as_view(),           name='school_reactivate'),
