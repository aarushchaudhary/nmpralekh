...
import com.aarushchaudhary.nmpralekh.databinding.ActivitySuperadminBinding;
...
public class SuperAdminActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_dashboard) {
            ...
            title = "Dashboard";
        } else if (id == R.id.nav_campus_users) {
            fragment = new CampusUsersFragment();
            title = "Campus Users";
