...
public class DeleteAuthHistoryFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.tvPageTitle.setText("History");
        binding.tvPageSubtitle.setText("View previously approved or rejected requests");

        binding.fabAdd.setVisibility(View.GONE);

        apiService = ApiClient.getApiService(requireContext());
        
        adapter = new AuditAdapter(requireContext(), true, null);
